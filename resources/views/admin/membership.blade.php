                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="view.php" class="btn-primary btn-x-sm mrg p-1"
                                                            data-placement="top" data-toggle="tooltip"
                                                            data-original-title="View"><i class="far fa-eye"></i></a>
                                                        <a href="edit.php" class="btn-warning btn-x-sm mrg p-1"
                                                            data-placement="top" data-toggle="tooltip"
                                                            data-original-title="Edit"><i class="far fa-edit"></i></a>
                                                        <a href="#"
                                                            onclick="return confirm('you are about to delete a record. This cannot be undone. are you sure?')"
                                                            class="btn-danger btn-x-sm mrg p-1" data-placement="top"
